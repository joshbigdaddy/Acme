...
<form:form action="order/consumer/cancel.do" modelAttribute="order">
<jstl:if test="${order.id != 0}">
	...
	<spring:message code="order.confirm.cancel"  /> 
	<br/>
</jstl:if>
	
<jstl:if test="${order.id != 0}">
<input type="submit" name="save"
		value="<spring:message code="order.cancelOrder" />" />
		
</jstl:if>
<a href="order/consumer/list.do">
