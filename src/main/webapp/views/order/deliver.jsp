...
<form:form action="order/clerk/deliver.do" modelAttribute="order">
<jstl:if test="${order.id != 0}">
	...
	<spring:message code="order.confirm.deliver"  /> 
	<br/>
</jstl:if>
	
<jstl:if test="${order.id != 0}">
<input type="submit" name="save"
		value="<spring:message code="order.deliver" />" />
